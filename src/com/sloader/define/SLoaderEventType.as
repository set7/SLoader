package com.sloader.define
{
	public class SLoaderEventType
	{
		...
		public static const SLOADER_START:String = "sloader_start";
		public static const SLOADER_PROGRESS:String = "sloader_progress";
		public static const SLOADER_COMPLETE:String = "sloader_complete";
	}
}